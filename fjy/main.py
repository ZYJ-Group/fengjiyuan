...
from chapters import (
    ...
    chap11, chap12_ista, chap13_fista, chap14_admm, chap15_ctn
)
...
def main():
    ...
    structure = {
        ...
        "第三部分：求解算法 (ISAR应用)": {
            "11. 平滑化梯度法 (Huber)": chap11,
            "12. 梯度类算法 (ISTA)": chap12_ista,
            "13. 加速梯度算法 (FISTA)": chap13_fista,
            "14. 算子分裂算法 (ADMM)": chap14_admm,
            "15. 总结": chap15_ctn,
        }
    }
